document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        'Korean British Lawyers Association (“KOBRLA”) is an independent, non-profit, unincorporated association established and governed under its Constitution. It is not a company, registered charity or statutory legal regulator. It promotes legal, educational and professional cooperation between the United Kingdom and the Republic of Korea. Contact:': '한영변호사협회(“KOBRLA”)는 영국과 대한민국 간 법률·교육·전문 분야의 협력을 증진하는 독립적인 비영리 전문 네트워크입니다. 문의:',
        ...
        'Legal Status & Independence': '법적 지위와 독립성',
        'KOBRLA is an independent, non-profit, unincorporated association established and governed under its Constitution. It is not a company, registered charity or statutory legal regulator. The Association promotes UK–Korea professional cooperation, education and community engagement and does not operate as a commercial referral service for any particular firm or business.': 'KOBRLA는 정관에 따라 설립·운영되는 독립적인 비영리 비법인협회입니다. 회사나 등록 자선단체 또는 법정 법률규제기관이 아닙니다. 협회는 한영 전문협력·교육·지역사회 참여를 증진하며 특정 로펌이나 기업을 위한 상업적 소개 서비스를 운영하지 않습니다.',
        'Information published by KOBRLA is general legal information, not advice on an individual case. Any separately organised legal clinic or pro bono service must have its own appropriate professional arrangements and clear terms of engagement.': 'KOBRLA가 게시하는 내용은 일반 법률정보이며 개별 사건에 대한 법률자문이 아닙니다. 별도로 운영되는 법률상담 클리닉 또는 프로보노 서비스에는 적절한 전문직 운영체계와 명확한 위임 조건이 마련되어야 합니다.',
        'Annual Membership Fees': '연회비 안내',
        'Membership subscriptions are charged annually, not monthly. The current annual fee schedule is:': '회원 회비는 월회비가 아닌 연회비로 납부합니다. 현재 연회비표는 다음과 같습니다.',
        '£30 per year': '연 £30',
        '£20 per year': '연 £20',
        '£5 per year': '연 £5',
        "Membership applications are subject to approval under the Association's Constitution. The membership year runs from 1 January to 31 December, and annual membership renews on 1 January. For members joining part-way through the year, the first-year fee is calculated by calendar days remaining from the admission date (inclusive) to 31 December, divided by the actual number of days in that year (365 or 366), and rounded down to the nearest whole pound. The payment due date, cancellation process and any refund terms will be confirmed before payment. Members may choose to arrange a standing order after receiving verified Association bank details; a standing order is optional and is not a condition of membership. Institutional membership fees are agreed separately. Please contact us to apply; this website does not currently collect membership payments.": '회원가입은 협회 정관에 따른 승인을 거칩니다. 회원연도는 1월 1일부터 12월 31일까지이며, 매년 1월 1일 갱신됩니다. 연도 중 가입자의 첫해 회비는 가입일을 포함하여 12월 31일까지 남은 일수를 해당 연도의 총일수(365일 또는 366일)로 나누어 일할 계산하고, 소수점 이하를 절사하여 파운드 정수 금액으로 정합니다. 납부기한과 탈퇴 및 환불 조건은 결제 전에 안내합니다. 회원은 협회의 확인된 은행계좌 안내를 받은 후 자동이체(Standing Order)를 선택할 수 있으나, 이는 선택사항이며 회원가입의 필수조건이 아닙니다. 기관회원 회비는 별도로 정합니다. 가입 신청은 협회에 문의해 주십시오. 현재 이 웹사이트에서는 회비를 결제받지 않습니다.',
        'Membership category (for membership enquiries)': '회원 구분 (가입 문의 시)',
        'Not applicable / please select': '해당 없음 / 선택해 주세요',
        'Full Member — £30/year': '정회원 — 연 £30',
        'Associate Member — £20/year': '준회원 — 연 £20',
        ...
        'UK–Korea business and international cooperation': '한영 비즈니스 및 국제협력',
        'Community legal education': '커뮤니티 법률교육',
        'Legal and policy forum': '법률 및 정책 포럼',
        'Membership and welfare': '회원관리 및 복지',
        'Events and communications': '행사 및 홍보',
        'A committee preference does not guarantee appointment. Membership enquiries are subject to eligibility review and approval; no payment is taken through this form.': '희망 위원회 선택이 위원 선임을 보장하지는 않습니다. 회원가입 문의는 자격 심사 및 승인을 거치며, 이 양식에서는 회비를 결제받지 않습니다.',
        'Benefits:': '혜택:',
