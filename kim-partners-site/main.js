document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        '£20 per year': '연 £20',
        '£5 per year': '연 £5',
        "Membership applications are subject to approval under the Association's Constitution. The membership year runs from 1 January to 31 December, and annual membership renews on 1 January. For members joining part-way through the year, the first-year fee is calculated by calendar days remaining from the admission date (inclusive) to 31 December, divided by the actual number of days in that year (365 or 366), and rounded down to the nearest penny. The payment due date, cancellation process and any refund terms will be confirmed before payment. Institutional membership fees are agreed separately. Please contact us to apply; this website does not currently collect membership payments.": '회원가입은 협회 정관에 따른 승인을 거칩니다. 회원연도는 1월 1일부터 12월 31일까지이며, 매년 1월 1일 갱신됩니다. 연도 중 가입자의 첫해 회비는 가입일을 포함하여 12월 31일까지 남은 일수를 해당 연도의 총일수(365일 또는 366일)로 나누어 일할 계산하고, 1페니 미만은 절사합니다. 납부기한과 탈퇴 및 환불 조건은 결제 전에 안내합니다. 기관회원 회비는 별도로 정합니다. 가입 신청은 협회에 문의해 주십시오. 현재 이 웹사이트에서는 회비를 결제받지 않습니다.',
        'Benefits:': '혜택:',
